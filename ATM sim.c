/* Kullanýcýdan bakiye ve çekilmek istenen tutarý iste.
eðer çekilmek istenen tutar bakiyeden fazlaysa "yetersiz bakiye yaz".
Eðer tutar bakiyeyi 100tl'nin altýna düþürecekse kritik seviye uyarýsý versin ve onay istesin*/
#include <stdio.h>
